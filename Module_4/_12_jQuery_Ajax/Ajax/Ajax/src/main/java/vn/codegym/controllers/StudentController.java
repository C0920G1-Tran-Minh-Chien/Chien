...
//        return "forward:/student";
    ...
    public ModelAndView showDeleteForm(@PathVariable int id){
        Student customer = studentService.findById(id);
        if(customer != null) {
            ...
            ModelAndView modelAndView = new ModelAndView("student/error");
            return modelAndView;
        }
    }

    @PostMapping("/delete")
    public String deleteCustomer(@ModelAttribute("customer") Student customer){
